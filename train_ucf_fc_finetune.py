...
file_loc_train = file_loc[0:int(0.96*len(file_loc))]
file_loc_valid = file_loc[int(0.96*len(file_loc)):]
...
for i in range(epoch):
    ...
    if acc_s > best_acc:
        model_final.save_weights("models/model_best_fc_finetune.weights")
        print("Model Saved")
        best_acc = acc_s
